# -*- coding: utf-8 -*-
"""
Created on Thu Feb 16 10:26:18 2023
...
#93,#47,#62
#youtube.com/watch?v=9zqgvsfbz8M&ab_channel=AskItLoud
#Step -1
import cv2
import numpy as np 
import math
...
while True:
    ...
    try:
        ...
        hull = cv2.convexHull(cm)#green color ki lines jo show ho raha thi
        
        cv2.drawContours(crop_image, [cm], -1, (50, 50, 150), 2)#these are the red color lines that are visible
        cv2.drawContours(crop_image, [hull], -1, (0, 255, 0), 2)
        
        #Step - 8
        # Find convexity defects #these are the white dots that are forming between the fingers(based on the angle)
